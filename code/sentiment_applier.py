...
folder_source = "../data/NewWeakLabelledData/" 
...
def classifier_func(index, index_df):
    ...
    if (not os.path.exists(output_filename)):
        ...
        analyst_report = pd.read_excel(folder_source + filename)


        # keep the rows with InClaim sentences
        # analyst_report = analyst_report[analyst_report['Inclaim'] == 1].reset_index(drop=True)
