    ...
    for i, seed in enumerate(seeds):
        for k, batch_size in enumerate(batch_sizes):
            for j, learning_rate in enumerate(learning_rates):
                ...
                df.to_excel(f'../data/grid_search_results/train_arpts_{data_category}_{language_model_to_use}.xlsx', index=False)
...
if __name__=='__main__':
    ...
    # experiments
    for language_model_to_use in ["bert", "bert-large", "finbert", "flangbert"]:#["roberta", "roberta-large"]: # provide list of models
